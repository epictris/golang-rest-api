...
const (
	...
	ServiceCreateUserProcedure = "/proto.v1.Service/CreateUser"
	// ServiceGetUserProcedure is the fully-qualified name of the Service's GetUser RPC.
	ServiceGetUserProcedure = "/proto.v1.Service/GetUser"
)

// ServiceClient is a client for the proto.v1.Service service.
type ServiceClient interface {
	CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error)
	GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error)
}

// NewServiceClient constructs a client for the proto.v1.Service service. By default, it uses the
...
func NewServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ServiceClient {
	...
	serviceMethods := v1.File_proto_v1_init_proto.Services().ByName("Service").Methods()
...
// CreateUser calls proto.v1.Service.CreateUser.
...
// GetUser calls proto.v1.Service.GetUser.
...
// ServiceHandler is an implementation of the proto.v1.Service service.
...
func NewServiceHandler(svc ServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.v1.Service/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.v1.Service.CreateUser is not implemented"))
}
...
func (UnimplementedServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.v1.Service.GetUser is not implemented"))
}
